...
import { FiSettings, FiCheck, FiSun, FiMoon, FiLogIn } from 'react-icons/fi';
...
function TranslateIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg
      className={className}
      fill="none"
...
export interface PopupHeaderProps {
  ...
  onThemeChange: (theme: 'light' | 'dark' | string) => void;
  onOpenSettings: () => void;
