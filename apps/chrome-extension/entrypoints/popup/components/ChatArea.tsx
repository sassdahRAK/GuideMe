...
export interface ChatMessageItem {
  role: 'user' | 'assistant' | 'auth-prompt' | string;
  content: string;
  image?: string;
  timestamp?: number;
  [key: string]: any;
...
interface AuthPromptMessageProps {
  msg: ChatMessageItem;
  language?: string;
}
 ...
 */
function AuthPromptMessage({ msg, language = 'km' }: AuthPromptMessageProps): React.ReactElement {
 ...
 */
function ChatMessage({ msg, language = 'km' }: ChatMessageProps): React.ReactElement {
 ...
 */
export function ChatArea({ messages = [], language = 'km' }: ChatAreaProps): React.ReactElement {
