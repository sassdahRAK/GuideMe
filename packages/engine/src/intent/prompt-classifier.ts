...
export type PromptCategory = 'greeting' | 'unclear' | 'actionable';
...
function normalizeText(text: string): string {
  ...
  return text
    .toLowerCase()
    .trim()
    // Specifically normalize stretched greeting vowels and vocatives
 ...
 */
function isGreetingEnglish(normalized: string): boolean {
 ...
 */
export function classifyPrompt(rawPrompt: string): PromptClassificationResult {
